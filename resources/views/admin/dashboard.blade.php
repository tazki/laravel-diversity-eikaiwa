															...
															<div class="metric-row metric-flush">
																	<div class="col">
																			<a href="user-teams.html" class="metric metric-bordered align-items-center">
																					<h2 class="metric-label"> {{ __('Total Number of Customers') }} </h2>
																	...
																	<div class="col">
																			<a href="user-projects.html" class="metric metric-bordered align-items-center">
																					<h2 class="metric-label"> {{ __('Total Number of User') }} </h2>
																					<p class="metric-value h3">
																	...
																	<div class="col">
																			<a href="user-tasks.html" class="metric metric-bordered align-items-center">
																					<h2 class="metric-label"> {{ __('Total Number of Active Customers') }} </h2>
																					<p class="metric-value h3">
									...
									<div class="row">
											<div class="col-12 col-lg-12 col-xl-4">
													<div class="card card-fluid">
															<div class="card-body">
																	<h3 class="card-title mb-4"> {{ __('New Registration Customer') }} </h3>
															...
															<div class="list-group list-group-flush">
																	<div class="list-group-item">
																			<div class="list-group-item-figure">
																					<a href="user-profile.html" class="user-avatar" data-tooltip="tooltip"
																	...
																	<div class="list-group-item">
																			<div class="list-group-item-figure">
																					<a href="user-profile.html" class="user-avatar" data-tooltip="tooltip"
																							title="Tammy Beck"><img src="images/avatars/uifaces15.jpg" alt=""></a>
																			</div>
																			<div class="list-group-item-body">
																					<div class="progress progress-animated bg-transparent rounded-0"
																							data-tooltip="tooltip" data-html="true"
																	...
																	<div class="list-group-item">
																			<div class="list-group-item-figure">
																					<a href="user-profile.html" class="user-avatar" data-tooltip="tooltip"
																							title="Susan Kelley"><img src="images/avatars/uifaces17.jpg" alt=""></a>
																			</div>
																			<div class="list-group-item-body">
																					<div class="progress progress-animated bg-transparent rounded-0"
																							data-tooltip="tooltip" data-html="true"
																	...
																	<div class="list-group-item">
																			<div class="list-group-item-figure">
																					<a href="user-profile.html" class="user-avatar" data-tooltip="tooltip"
																							title="Albert Newman"><img src="images/avatars/uifaces18.jpg" alt=""></a>
																			</div>
																			<div class="list-group-item-body">
																					<div class="progress progress-animated bg-transparent rounded-0"
																							data-tooltip="tooltip" data-html="true"
																	...
																	<div class="list-group-item">
																			<div class="list-group-item-figure">
																					<a href="user-profile.html" class="user-avatar" data-tooltip="tooltip"
																							title="Kyle Grant"><img src="images/avatars/uifaces19.jpg" alt=""></a>
																			</div>
																			<div class="list-group-item-body">
																					<div class="progress progress-animated bg-transparent rounded-0"
																							data-tooltip="tooltip" data-html="true"
