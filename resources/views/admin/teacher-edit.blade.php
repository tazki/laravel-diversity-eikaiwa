            ...
            <form enctype="multipart/form-data" action="{{ (isset($row->id)) ? route('teachers_update', ['id' => $row->id]) : route('teachers_add') }}" method="POST">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- form column -->
                        <div class="col-md-9 mb-3">
                            <textarea name="lang[1][about_you]" class="form-control" id="about_you_en" rows="10">{{ (isset($lang[1]['about_you'])) ? $lang[1]['about_you'] : '' }}</textarea> <small class="text-muted">Appears on your profile page, 300 chars max.</small>
                        </div><!-- /form column -->
                        </div><!-- /form row -->
                        <!-- form row -->
                        <div class="form-row">
                        ...
                        <!-- form column -->
                        <div class="col-md-9 mb-3">
                            <textarea name="lang[2][about_you]" class="form-control" id="about_you_jp" rows="10">{{ (isset($lang[2]['about_you'])) ? $lang[2]['about_you'] : '' }}</textarea> <small class="text-muted">Appears on your profile page, 300 chars max.</small>
                        </div><!-- /form column -->
                        </div><!-- /form row -->
                        <hr>
                        <!-- .form-actions -->
