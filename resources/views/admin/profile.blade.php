					...
					<div class="col-lg-8">
						<div class="tab-content" id="nav-tabContent">
							<div class="tab-pane fade show active" id="profile" role="tabpanel"
								...
								<form enctype="multipart/form-data" method="POST" action="{{ url('admin/profile/update') }}" class="auth-form is-fullwidth">
									@csrf
							...
							<div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
								<form method="POST" action="{{ url('admin/profile/password') }}" class="auth-form is-fullwidth">
									@csrf
									<div class="col-md-12">
										<div class="form-group">
