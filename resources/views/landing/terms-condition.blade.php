    ...
    <div id="fh5co-about">
        <div class="container">
            <div class="col-md-12 animate-box">
                ...
                <p>{{ __('In connection to quitting, students can unsubscribe before their subscription date renew the user’s credits. Also, as mentioned in the monthly subscription plan, it will automatically deduct 6,800 yen/12,100 yen depending on the plan that the student had chosen, or they should pay it via convenient stores, or their accounts will be deactivated.') }}</p>
            </div>
        </div>
    </div>
