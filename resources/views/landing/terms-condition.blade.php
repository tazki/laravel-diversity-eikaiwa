    ...
    <div id="fh5co-about">
        <div class="container">
            <div class="col-md-12 animate-box">
                ...
                <p>{{ __('Please take note that the only time we will do refunds is when technical issues arrises that would affect both teachers and student’s lesson. As a rule, you need to make a report from the day you experience issues that affect you schedule. Report should me made within 7 days or else, we won’t be able to refund it.') }}</p>
            </div>
        </div>
    </div>
